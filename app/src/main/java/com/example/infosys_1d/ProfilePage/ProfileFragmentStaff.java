...
public class ProfileFragmentStaff extends Fragment {
    ...
    public ProfileFragmentStaff() {}

    public static ProfileFragmentStaff newInstance(String param1, String param2) {
        ProfileFragmentStaff fragment = new ProfileFragmentStaff();
