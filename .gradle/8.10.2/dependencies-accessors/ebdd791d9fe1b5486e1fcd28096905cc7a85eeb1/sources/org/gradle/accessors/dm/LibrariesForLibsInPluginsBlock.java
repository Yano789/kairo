...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ProlificLibraryAccessors laccForProlificLibraryAccessors = new ProlificLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>prolific</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ProlificLibraryAccessors getProlific() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForProlificLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class ProlificLibraryAccessors extends SubDependencyFactory {
        private final ProlificCalendarLibraryAccessors laccForProlificCalendarLibraryAccessors = new ProlificCalendarLibraryAccessors(owner);

        public ProlificLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>prolific.calendar</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ProlificCalendarLibraryAccessors getCalendar() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForProlificCalendarLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ProlificCalendarLibraryAccessors extends SubDependencyFactory {

        public ProlificCalendarLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>view</b> with <b>com.github.prolificinteractive:material-calendarview</b> coordinates and
         * with version reference <b>prolific.calendar</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getView() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("prolific.calendar.view");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ProlificVersionAccessors vaccForProlificVersionAccessors = new ProlificVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.prolific</b>
         */
        public ProlificVersionAccessors getProlific() {
            return vaccForProlificVersionAccessors;
        }
    ...
    public static class ProlificVersionAccessors extends VersionFactory  {

        public ProlificVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>prolific.calendar</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCalendar() { return getVersion("prolific.calendar"); }
